/**
 * Auto-generated chain API types for the Signer pipeline.
 * These types enable fluent chaining of transaction methods:
 *   signer.transfer({...}).issue({...}).sign()
 *
 * Previously generated at build time by generateInterface.ts.
 * Now committed as source to remove the build-time code generation step.
 */

// biome-ignore format: legacy formatting preserved
import {
  type AliasArgs,
  type BroadcastedTx,
